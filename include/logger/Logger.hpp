...
class Logger
{
	...
	private:
		...
		static std::string	BG_BLUE()		{ return "\033[48;2;30;60;120m"; }
		static std::string	C_BLUE()		{ return "\033[38;2;80;140;220m"; }
		static std::string	BG_BRIGHT_RED()	{ return "\033[48;2;140;20;20m"; }
		static std::string	C_BRIGHT_RED()	{ return "\033[38;2;255;80;80m"; }
};
